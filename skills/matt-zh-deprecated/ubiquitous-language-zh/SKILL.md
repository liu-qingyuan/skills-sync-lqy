...
> 这是 Matt Pocock `ubiquitous-language` skill 的中文本地化版本。官方英文上游保留在 `upstream/mattpocock/skills/deprecated/ubiquitous-language`；本目录可按中文团队习惯继续调整。
...
- **固执己见。** 当同一概念存在多个单词时，选择最好的一个并将其他单词列为要避免的别名。
