---
name: playwright-cli
description: Automates browser interactions for testing and validating your own web applications using playwright-cli. Use when you need terminal-first browser control for navigation, form filling, screenshots/videos, tracing, bound browser sessions, debugging, generating Playwright test code, or capturing Electron app evidence from Playwright `_electron.launch()` workflows. Only use against applications you own or have explicit authorization to test.
---
...
12. **Electron video needs fixture support** — for Playwright Electron apps launched with `_electron.launch()`, `use.video` may not create `.webm`; pass `recordVideo` to `_electron.launch()` or add an env-controlled fixture switch
...
playwright-cli video-start                   # Start browser video recording
playwright-cli video-stop output.webm        # Stop and save browser video
# Electron E2E: configure recordVideo in _electron.launch(); see screenshots-and-media.md
